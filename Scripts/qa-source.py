...
if 'ROZZA 4.0.5 · PERFORMANCE AUTOPLAY' not in html: errors.append('wrong visible version label')
...
for token in ['MARKETING_VERSION: 4.0.5','CURRENT_PROJECT_VERSION: 25','Resources/yt_background_bridge.js','path: rozza2.html']:
...
if errors:
    ...
    sys.exit(1)
print(f'ROZZA PERFORMANCE-AUTOPLAY source QA PASS — {len(p.ids)} ids, no duplicates, production debug UI gated.')
