...
Do not build an `ios/` subfolder. ROZZA 4.2.0 Build 30 intentionally removed the old duplicate iOS project so there is only one playback stack and one source of truth.
